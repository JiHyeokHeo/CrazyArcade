...
int APIENTRY wWinMain(_In_ HINSTANCE hInstance, // CALLBACK으로 써도 된다. 나중에 개발환경에 맞춰서
                     ...
                     _In_ int       nCmdShow)
{
   ...
   /* SetCursor(hCursor);*/
    ...
    while (true)
    {
        if (PeekMessage(&msg, nullptr, 0, 0, PM_REMOVE)) // 메시지가 있을때 // PeekMessage는 Get과 다르게 지워주는 작업이 필요
        {
